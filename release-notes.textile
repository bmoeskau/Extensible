...
h2. 2.0 (Ext 4 support)

This release was strictly for implementing Ext 4 support in the calendar components. No new features were implemented or bugs fixed that would have otherwise gone into the Ext 3.x branch.  Going forward the 2.x branch of Extensible will maintain Ext 4 support, and the 1.x branch of Extensible will remain on Ext 3.x.
