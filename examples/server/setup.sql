...
INSERT INTO `events` (`calendar_id`,`title`,`start`,`end`,`location`,`notes`,`url`,`all_day`,`reminder`)
VALUES
    (1, 'Vacation', DATE_ADD(@dt, INTERVAL -20 DAY), DATE_ADD(@dt, INTERVAL -10 DAY), '', 'Have fun', '', 0, ''),
    (2, 'Lunch with Matt', DATE_ADD(@dt, INTERVAL '11:30' HOUR_MINUTE), DATE_ADD(@dt, INTERVAL 13 HOUR), 'Chuy\'s', 'Order the queso', 'http://chuys.com', 0, '15'),
    (3, 'Project due', DATE_ADD(@dt, INTERVAL 15 MINUTE), DATE_ADD(@dt, INTERVAL 15 MINUTE), '', '', '', 0, ''),
    (1, 'Sarah\'s birthday', @dt, @dt, '', 'Need to get a gift', '', 1, ''),
    (2, 'A long one...', DATE_ADD(@dt, INTERVAL -12 DAY), DATE_ADD(@dt, INTERVAL 10 DAY), '', '', '', 1, '')
