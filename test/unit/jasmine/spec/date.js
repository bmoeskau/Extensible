describe("Extensible.Date", function() {
    ...
    describe('Date.diffTimezone()', function() {

        var tzOffsetStandard = '-0600',
            tzOffsetDst = '-0500';

        it ('for the same timezone', function() {
            var start = new Date('2013-01-15T01:00:00' + tzOffsetStandard),
                end   = new Date('2013-01-15T22:00:00' + tzOffsetStandard),
                diff  = ExteDate.diffTimezones(start, end);
        ...
        it ('spanning fall DST boundary (US)', function() {
            var start = new Date('2013-11-02T01:00:00' + tzOffsetStandard),
                end   = new Date('2013-11-04T01:00:00' + tzOffsetDst),
                diff  = ExteDate.diffTimezones(start, end);
